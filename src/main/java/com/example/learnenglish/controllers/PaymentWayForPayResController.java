...
public class PaymentWayForPayResController {
    ...
    private final PaymentWayForPayController paymentWayForPayController;
...
//            paymentWayForPayController.paymentSuccess(paymentWayForPayService.endOfPayment(payment));
            RedirectView redirect = new RedirectView("/payment-success");
            return redirect;
